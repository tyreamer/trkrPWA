    ...
    render() {
        ...
        return (
            <Col xs="12" sm={{ size: 6 }} lg={{ size: 4 }} style={{ width: 300, marginBottom: 50 }}> 
                <Row className="trek-link" onClick={() => this.goToPost()} style={{ backgroundColor: 'rgba(255,255,255,.2)', color: '#fff', paddingTop: 5, borderTopLeftRadius: 15, borderTopRightRadius: 15  }}>
                    <Col xs="12">
